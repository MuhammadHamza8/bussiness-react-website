...
export default function CasesSection() {
  return (
    <div className='mt-[98px]'>
        ...
        <h1 className='text-[44px] font-black text-center text-[#1E1E1E] underline underline-offset-1'>Our Cases</h1>

        <div className='flex justify-center mt-[68px] gap-x-[85px] '>
