...
export default function Hero({footerData}) {
    return (
        <div className='container mx-auto grid grid-cols-2  xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 '>
{footerData}
            <div className='mt-[117px] pb-9'>
                <h1 className='  lg:text-[44px] font-black text-[#1E1E1E]'>Our Research & <br/> Case Studies </h1>
