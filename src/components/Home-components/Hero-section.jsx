...
export default function Hero() {
  return (
    <div className="container mx-auto grid sm:col-span-1 sm:gap-y-6  lg:col-span-2">
    ...
    <div className=' sm:mx-auto lg:ml-[600px]'>
      <img  className='sm:max-w-sm  lg:max-w-2xl ' src='assets/images/2.png'  alt='img'/>
    </div>
