...
<div className=' sm:flex-col   md:flex-col mx-auto lg:bg-blue-500  md:bg-red-400 sm:bg-slate-600  sm:w-full md:w-full lg:w-full xl:w-full'>
  ...
  <img src="assets/images/logo.png"  className=" mx-auto sm:w-[150px] sm:h-[20px] md:w-44 md:h-8" alt="img" />
    ...
    <ul className='sm:flex sm:px-4 sm:py-2 sm:justify-center sm:gap-x-3 md:flex md:px-2 md:py-4  md:gap-x-4 md:mt-4 md:justify-items-center'>
    ...
    <div className='sm:flex sm:gap-3 sm:justify-center md:flex md:gap-x-6 md:justify-center md:mt-7  '>
