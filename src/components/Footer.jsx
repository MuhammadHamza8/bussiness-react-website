...
export default function Footer() {
  return (
<div className='xs:flex-col  sm:flex-col  md:flex-col mx-auto '>

  
  <div className='xs:py-2 sm:py-2 '>
  <img src="assets/images/logo.png"  className=" mx-auto sm:w-[150px] sm:h-[20px] md:w-44 md:h-8" alt="img" />
  </div>

    <ul className='  xs:flex  xs:gap-x-3 xs:py-3 xs:justify-center  sm:flex sm:px-4 sm:py-2 sm:justify-center sm:gap-x-3 md:flex md:px-2 md:py-4  md:gap-x-4 md:mt-4 md:justify-items-center'>
